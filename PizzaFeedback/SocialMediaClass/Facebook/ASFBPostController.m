...
// Facebook
#define FB_APP_ID             @"692543607438745"
...
- (void)actionSave{
    ...
    [params setObject:self.textView.text forKey:@"message"];
    [params setObject:@"link" forKey:@"type"];
    [params setObject:self.url forKey:@"link"];
    [params setObject:self.originalImage forKey:@"source"];
    
    NSString *graphPath = @"me/feed";
    
    [self.facebook requestWithGraphPath:graphPath andParams:params andHttpMethod:@"POST" andDelegate:self];
}
